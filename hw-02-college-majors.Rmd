...
You will notice that when you go to knit that the packages have not been installed.
You can install them manually or click yes when R asks you.
...
The top three majors are early childhood education, communication disorders sciences and services, and medical assisting services.
...
The median is a more accurate measurement than the mean.
This makes more sense cause it is not impacted by any extremes.
...
I choose binwidth 5,000 because of the better label of the x-axis
...
Shape would be the the best way to describe the distribution.
The spread is pretty normal with one outstanding outlier.
It hits it's peak about half way through but has more information on the right side.
Most people have an income of around 40,000 dollars.
...
![](https://bdd51dbdb4a94ef0b2cf86ea3f083340.app.posit.cloud/graphics/64a1e2c9-40ca-4dd1-80f5-c255e7bf0f54.png)
...
Engineering is the highest median income.
...
The least popular major is interdisciplinary with 1 observation.
...
1.Geosciences, 2.Environmental Science, 3.Multi-Disciplinary Or General Science, 4.Physiology, 5.Communication Technologies, 6.Neuroscience, 7.Atmospheric Sciences And Meteorology, 8.Miscellaneous Biology, 9.Biology, 10.Ecology, 11.Zoology.
These all have salaries equal to or less then the median salary of all the majors.
...
This shows that more women are in no stem majors than in stem majors.
This also shows that they usually end up in more high income jobs than not.

![](https://bdd51dbdb4a94ef0b2cf86ea3f083340.app.posit.cloud/graphics/5d4c4926-bef5-4f8c-bc3b-fc124eb948e1.png)

## Further exploration

10. Ask a question of interest to you, and answer it using summary statistic(s) and/or visualization(s).

Most common major that women go into?

The most common major for women to go into is engineering with 57,000
...
nit, *commit, and push your changes to GitHub with an appropriate commit message. Make sure to commit and push all changed files so that your Git pane is cleared up afterwards and review the md document on GitHub to make sure you're happy with the final state of your work.*
